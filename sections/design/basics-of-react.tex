...
A component can however pass its state through \texttt{props} to a child components, which means that information about a state can only be passed in a \textit{top-down} approach. 
