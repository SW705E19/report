...
\\\\
The main advantage of an SPA is the high speed that comes with the unnecessity of having to contact the server to load all elements with each new page.
