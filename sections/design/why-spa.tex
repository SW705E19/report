...
One is a Single Page Application (SPA), the other is a Multi Page application (MPA).
...
There are also other frameworks such as Angular or Vue which architecture allow for development of dynamic web application just as React does. 
\\\\
The main advantages of an SPA is the high speed that comes the unnecessity to load all elements with each new page but only load the changed elements. 
