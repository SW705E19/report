...
The figure shows a board on Trello that we used to give an overview of how far people were with their tasks.
...
\\\\
However, as the project progressed and we started to develop the system and had to learn about React, the process started to become less systematic.
...
When we got more familiar with React we were able to estimate how much work the tasks would take to complete, and the process got more systematic again.
\\\\
We also stopped conducting the retrospective meetings.
The primary reason behind this was that the Scrum Masters stopped enforcing the retrospective meetings so they faded out.
...
\\\\
This increased the quality of the code in the pull requests, as more errors were caught when two people had to debate the code.
...
This was really beneficial as the developers more familiar with React were able to help other members that were less familiar.
...
One of the solutions to this could be daily stand ups, so that we are aware of where people are with their tasks, and which ones they have not completed.
