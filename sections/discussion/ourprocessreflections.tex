...
A reason for this can also be that the developers were able to see the design pattern from other pages, which could give them a good idea of how to solve the tasks.
