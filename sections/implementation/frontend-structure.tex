...
Within the state of CreateUser, there is the object firstName, which contains a first name and a boolean to see if it is valid.
It is instantiated as being true, so that the error messages aren't showing when entering the page.
