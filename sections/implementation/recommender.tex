...
\begin{figure}[H]
 ...
 \end{figure}
 \noindent
To learn the factor vectors $p_{u}$ and $q_{i}$, the recommender system minimizes the squared error of the set of known ratings, that is, the entries in the ratings matrix that have a value:
 \begin{figure}[H]
    \centering
 ...
 \end{figure}
 \noindent
 $K$ is the set of $(u, i)$ pairs for which the rating $r_{ui}$ is known.
 ...
 For each case, the system predicts a rating, and then computes the prediction error with the following equation:
 \begin{figure}[H]
    \centering
 ...
 \end{figure}
 \noindent
 After the error has been calculated, the algorithm modifies the parameters through the following update rules:
 \begin{figure}[H]
    \centering
